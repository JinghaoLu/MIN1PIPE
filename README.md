...
## Updates
***3/25/2022*** **New version released (v3.1 & v4.0.1 (beta)): MIN1PIPE now automatically detects **`se`** and *`spatialr`**. Please refer to the release notes for syntax. Feedbacks regarding the bugs and/or suggestions are welcome.**
