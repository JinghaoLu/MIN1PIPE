...
%   Jinghao Lu, 03/21/2018
    ...
    Params.Fsi_new = 10;
    Params.spatialr = 0.5;
    Params.bg_remove_size = 9; %%% half neuron size; 9 for Inscopix and 5 for UCLA, with 0.5 spatialr separately %%%
    ...
    Params.mc_scl = 0.004;
    Params.mc_sigma_x = 3;
    Params.mc_sigma_f = 0.5;
    Params.mc_sigma_d = 10;
    Params.pix_select_sigthres = 1.5;                                   
